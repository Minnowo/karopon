...
func CreateSampleData(ctx context.Context, db DB, username string) error {
	...
	foods := []TblUserFood{
		...
		{
			UserID:  user.ID,
			Name:    "whey - ON Gold Standard - Natural Vanilla",
			Portion: 32,
			Unit:    "g",
			Protein: 24,
			Carb:    5,
		...
		{
			UserID:  user.ID,
			Name:    "cassein - ON Gold Standard - Natural Chocolate",
			Portion: 38,
			Unit:    "g",
			Protein: 24,
			Carb:    8,
		...
		{
			UserID:  user.ID,
			Name:    "oatmeal - quaker - large flake",
			Portion: 30,
			Unit:    "g",
			Protein: 4,
			Carb:    20,
		...
		{
			UserID:  user.ID,
			Name:    "teen burger and fries combo - A&W",
			Portion: 1,
			Unit:    "combo",
			Protein: 25,
			Carb:    90,
		...
		{
			UserID:  user.ID,
			Name:    "collagen - Progressive Complete Collagen",
			Portion: 10,
			Unit:    "g",
			Protein: 10,
			Carb:    0,
		...
		{
			UserID:  user.ID,
			Name:    "ice cream - Haagen Dazs - Coffee",
			Portion: 125,
			Unit:    "ml",
			Protein: 5,
			Carb:    22,
		...
		{
			UserID:  user.ID,
			Name:    "ice cream - Haagen Dazs - Green Tea",
			Portion: 125,
			Unit:    "ml",
			Protein: 5,
			Carb:    21,
		...
		{
			UserID:  user.ID,
			Name:    "fish - english style great value",
			Portion: 118,
			Unit:    "g",
			Protein: 11,
			Carb:    19,
		...
		{
			UserID:  user.ID,
			Name:    "hamburger bun - great value",
			Portion: 45,
			Unit:    "g",
			Protein: 4,
			Carb:    23,
		...
		{
			UserID:  user.ID,
			Name:    "ice cream - irresistables dutch chocolate",
			Portion: 188,
			Unit:    "g",
			Protein: 2,
			Carb:    32,
		...
		{
			UserID:  user.ID,
			Name:    "potato - red - baked - with skin",
			Portion: 100,
			Unit:    "g",
			Protein: 2.3,
			Carb:    19.59,
		...
		{
			UserID:  user.ID,
			Name:    "bean - red kidney - canned - drained",
			Portion: 100,
			Unit:    "g",
			Protein: 8.7,
			Carb:    24.72,
